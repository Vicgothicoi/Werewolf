...
TOKEN_COSTS = {
    ...
    # Moonshot / Kimi models (price per 1K tokens, CNY converted to USD approx)
    ...
    "kimi-k2-turbo-preview": {"prompt": 0.014, "completion": 0.014},
    "kimi-k2-0711-preview": {"prompt": 0.014, "completion": 0.014},
    "kimi-k2-0905-preview": {"prompt": 0.014, "completion": 0.014},
    "kimi-k2.5": {"prompt": 0.014, "completion": 0.014},
    # DeepSeek models (price per 1K tokens, USD)
...
def count_message_tokens(messages, model="gpt-3.5-turbo-0613"):
    ...
    if model in {
        ...
        # 未知模型（如 Kimi/Moonshot）用 gpt-4 tokenizer 估算
        return count_message_tokens(messages, model="gpt-4-0613")
    num_tokens = 0
