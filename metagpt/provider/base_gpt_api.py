...
class BaseGPTAPI(BaseChatbot):
    ...
    async def aask_with_tools(
        ...
        """Ask with tool/function calling. Subclasses that support it should override this.
        Falls back to plain aask + json parsing for providers that don't support tools.
        """
        raise NotImplementedError(
            "This LLM provider does not support tool/function calling."
        )
